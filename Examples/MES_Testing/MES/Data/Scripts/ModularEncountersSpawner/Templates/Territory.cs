...
namespace ModularEncountersSpawner.Templates{
	...
	public class Territory{
		...
		public NPCTerritory TerritoryDefinition {get; set;}
		...
		public List<long> PlayersInTerritory {get; set;}
		
		public Territory(){
			
			Name = "";
			TerritoryDefinition = new NPCTerritory();
			Active = true;
			...
			CustomArriveMessage = "";
			CustomDepartMessage = "";
			PlayersInTerritory = new List<long>();
